...
class Series extends Component {
  ...
  render() {
    ...
    const portraitImgFullURL =
      series && series.portrait_image && series.portrait_image.full_url;
    const landscapeImgFullURL =
      series && series.landscape_image && series.landscape_image.full_url;

    // the latest collection would probably be the last one in the list...
    const latestCollectionId =
      loaded && seriesCollection[seriesCollection.length - 1];
    const latestCollection =
      latestCollectionId && collections[latestCollectionId];
                ...
                <CardBody className="main-details-card-body">
                  <div className="row">
                    <div
                      ...
                      style={isSmallScreen ? { marginTop: "-100px" } : {}}
                    >
                      <div>
                        <Img
                    ...
                    <div className="col-sm-8 col-lg-9">
                      ...
                      {anilistItem && anilistItem.nextAiringEpisode ? (
                        <Alert>
                          <Badge color="primary">AniList</Badge> The next
                          episode of{" "}
                          <strong>
                          ...
                          will air{" "}
                          {moment
                            .unix(anilistItem.nextAiringEpisode.airingAt)
                            .fromNow()}
                          .
                        </Alert>
                      ) : null}
