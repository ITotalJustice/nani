...
class ProgressBar extends Component {
  ...
  onMouseMove(e) {
    ...
    const mousePosition =
      e.nativeEvent.layerX / this.barRef.current.clientWidth;
    ...
    return (
      ...
      >
        <div
          ...
          className={classNames("video-timestamp text-white", {
            "d-none": !hovering,
          })}
          // get the width of this element and remove half of it to center...
          style={{
            left: `calc(${mousePosition * 100}% - ${
              ((this.timestampRef.current &&
                this.timestampRef.current.getBoundingClientRect().width) ||
                0) / 2
            }px)`,
          }}
        >
        ...
        <div className="progress" id="video-progress" ref={this.barRef}>
          ...
          />
          {loadedPercent > progressPercent && (
            <div
              className="progress-bar bg-secondary progress-percent"
              style={{
