...
class SeriesCard extends Component {
  render() {
    ...
    const imgFullURL =
      data && data.portrait_image && data.portrait_image.full_url;
    return (
        ...
        >
          ...
          >
            ...
            <CardBody className="p-2">
              ...
              <small className="d-block text-truncate text-secondary">
                {data.media_count || 0} Videos
              </small>
            </CardBody>
          </Link>
        </Card>
